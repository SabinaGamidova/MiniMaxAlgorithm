class Game
  ...
  def player_shot
    ...
    while @computer_board.cells[@given_coor].fired_upon? == true
      puts "\nYou have already fired upon that space, choose again:"
      puts ">" + "#{@given_coor = gets.chomp.upcase}"
    end
  ...
  def player_results
    if @computer_board.cells[@given_coor].ship == nil
      ...
      puts "\nYour shot on #{@given_coor} sunk my battleship!"
    else
      puts "\nYour shot on #{@given_coor} was a hit."
    end
  end

  def comp_results
    if @player_board.cells[@poss_cpu_shot].ship == nil
      puts "\nMy shot on #{@poss_cpu_shot} was a miss."
    elsif @player_board.cells[@poss_cpu_shot].ship.sunk? == true
      puts "\nMy shot on #{@poss_cpu_shot} sunk your battleship!"
    else
      puts "\nMy shot on #{@poss_cpu_shot} was a hit."
    end
  end
